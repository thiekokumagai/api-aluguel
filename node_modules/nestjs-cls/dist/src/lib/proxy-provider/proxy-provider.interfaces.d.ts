import { InjectionToken, OptionalFactoryDependency, Provider, Type } from '@nestjs/common';
...
export type ProxyProviderDefinition = ProxyClassProviderDefinition | ProxyFactoryProviderDefinition;
export {};
